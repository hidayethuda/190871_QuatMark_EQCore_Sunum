...
\subtitle{\includegraphics[height=2.9ex]{images/pngegg.png} 1501 TÜBİTAK Sanayi AR-GE Projeleri Destekleme Programı}
...
\begin{tikzpicture}[remember picture, overlay]
    \node at (current page.center) % Şeffaflığı ayarlayın
      {{\transparent{0.2}
...
\begin{itemize}
\item Yüksek matematik ve mühendislik
...
\item[2.] İçerik ve Kimlik Doğrulaması
...
\begin{frame}
  ...
  \begin{alertblock}{Değerlendirme Stratejisi: Neden MD5 ile Başlıyoruz?}
    \begin{itemize}
        ...
        \item \textbf{2. Aşama:} Takip eden analizlerde, aynı anahtar ile MD5, SHA-1, SHA-2 ve SHA-3 çıktılarını kullanarak algoritmanın sağlamlığını  karşılaştıracağız.
...
\begin{frame}
  \frametitle{LCG Alternatifleri ile İndeks Üretimi}

  \begin{block}{Neden LCG Değil?}
    LCG hızlıdır; ancak \textbf{tahmin edilebilirlik} ve \textbf{örüntü/korelasyon} nedeniyle
    saldırı altında zayıftır.
  \end{block}

  \vspace{0.2cm}

  \begin{block}{LCG Yerine Kullanılabilecek Alternatifler }
    \begin{itemize}
      \item \textbf{CSPRNG/DRBG :} ChaCha20, AES-CTR, HMAC/Hash-DRBG
...
\item Hash fonksiyonu ile rastgele bloklar seçilir
...
MD5 güvenlik zafiyeti & Kaotik şifreleme & SHA-2'ya geçiş \\
