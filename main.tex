...
\subtitle{\texorpdfstring{\includegraphics[height=2.9ex]{images/pngegg.png} }{}TÜBİTAK 1507 -- KOBİ Ar-Ge Başlangıç Destek Programı}
...
\facilityphoto[trim=0 430 0 436,clip]{images/bina_baseline.jpg}{4.5cm}{Sakarya Teknokent Binası}
\end{block}

\column{0.5\textwidth}
\begin{block}{\makebox[\linewidth][c]{QuatVision Ofisi}}
\facilityphoto{images/ofis_baseline.jpg}{4.5cm}{QuatVision Ofisi}
\end{block}
\end{columns}
