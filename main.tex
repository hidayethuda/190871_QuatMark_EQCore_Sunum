...
\facilityphoto[trim=0 430 0 436,clip]{images/bina.jpeg}{3.5cm}{Sakarya Teknokent Binası}
\end{block}

\column{0.5\textwidth}
\begin{block}{\makebox[\linewidth][c]{QuatVision Ofisi}}
\facilityphoto{images/ofis.jpeg}{3.5cm}{QuatVision Ofisi}
\end{block}
\end{columns}

\vspace{0.2cm}
\begin{alertblock}{Altyapı Uygunluğu}
\scriptsize 45 m$^2$ ofis alanı; proje personelinin yazılım geliştirme, matematiksel modelleme, deneysel test, raporlama ve mevcut QuatMark SaaS/API altyapısına entegrasyon çalışmalarını yürütmesi için yeterlidir.
\end{alertblock}
\end{frame}
